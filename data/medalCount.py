...
#total medal trends - sample years (2 year increments)

#1924, 1948, 1968, 1984, 2006, 2014
#columns 0 (year) column 4 (country)
...
#outpt a chart here! A line chart would probably be best!
...
plt.title("Medals Sampled by 20 Year Radous")
plt.show()
